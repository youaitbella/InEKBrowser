...
namespace org.inek.InekBrowser.Data {
    ...
    public class CsvData {
        ...
        private void MapSystemInfoDrg(string[] tokens) {
            ...
            si.GenderMale = decimal.Parse(tokens[10]);
            si.GenderFemale = decimal.Parse(tokens[11]);
            si.GenderUnknown = decimal.Parse(tokens[12]);
            si.AgeBelow28Days = decimal.Parse(tokens[13]);
            si.AgeBelow1Year = decimal.Parse(tokens[14]);
            si.AgeBelow3Years = decimal.Parse(tokens[15]);
            si.AgeBelow6Years = decimal.Parse(tokens[16]);
            si.AgeBelow10Years = decimal.Parse(tokens[17]);
            si.AgeBelow16Years = decimal.Parse(tokens[18]);
            si.AgeBelow18Years = decimal.Parse(tokens[19]);
            si.AgeBelow30Years = decimal.Parse(tokens[20]);
            si.AgeBelow40Years = decimal.Parse(tokens[21]);
            si.AgeBelow50Years = decimal.Parse(tokens[22]);
            si.AgeBelow55Years = decimal.Parse(tokens[23]);
            si.AgeBelow60Years = decimal.Parse(tokens[24]);
            si.AgeBelow65Years = decimal.Parse(tokens[25]);
            si.AgeBelow75Years = decimal.Parse(tokens[26]);
            si.AgeBelow80Years = decimal.Parse(tokens[27]);
            si.AgeBelow99Years = decimal.Parse(tokens[28]);
            si.LosShort = decimal.Parse(tokens[29]);
            si.LosNormal = decimal.Parse(tokens[30]);
            si.LosLong = decimal.Parse(tokens[31]);
            si.Day1Reduction = int.Parse(tokens[32]);
            si.Day1Remuneration = int.Parse(tokens[33]);
            si.LosAverage = decimal.Parse(tokens[34]);
            si.ValuationRatio = decimal.Parse(tokens[35]);
            si.FractionAllCases = decimal.Parse(tokens[36]);
            si.LosStandard = decimal.Parse(tokens[37]);
            si.CostAverage = decimal.Parse(tokens[38]);
            si.CostStandard = decimal.Parse(tokens[39]);
            _systemInfo.Add(si);
        }
        ...
        private void MapSystemInfoP21(string[] tokens) {
            ...
            var si = new SystemInfo {
                ...
                PCCL5 = decimal.Parse(tokens[8]),
                PCCL6 = decimal.Parse(tokens[9]),
                GenderMale = decimal.Parse(tokens[10]),
                GenderFemale = decimal.Parse(tokens[11]),
                GenderUnknown = decimal.Parse(tokens[12]),
                AgeBelow28Days = decimal.Parse(tokens[13]),
                AgeBelow1Year = decimal.Parse(tokens[14]),
                AgeBelow3Years = decimal.Parse(tokens[15]),
                AgeBelow6Years = decimal.Parse(tokens[16]),
                AgeBelow10Years = decimal.Parse(tokens[17]),
                AgeBelow16Years = decimal.Parse(tokens[18]),
                AgeBelow18Years = decimal.Parse(tokens[19]),
                AgeBelow30Years = decimal.Parse(tokens[20]),
                AgeBelow40Years = decimal.Parse(tokens[21]),
                AgeBelow50Years = decimal.Parse(tokens[22]),
                AgeBelow55Years = decimal.Parse(tokens[23]),
                AgeBelow60Years = decimal.Parse(tokens[24]),
                AgeBelow65Years = decimal.Parse(tokens[25]),
                AgeBelow75Years = decimal.Parse(tokens[26]),
                AgeBelow80Years = decimal.Parse(tokens[27]),
                AgeBelow99Years = decimal.Parse(tokens[28]),
                LosShort = decimal.Parse(tokens[29]),
                LosNormal = decimal.Parse(tokens[30]),
                LosLong = decimal.Parse(tokens[31]),
                Day1Reduction = int.Parse(tokens[32]),
                Day1Remuneration = int.Parse(tokens[33]),
                LosAverage = decimal.Parse(tokens[34]),
                ValuationRatio = decimal.Parse(tokens[35]),
                FractionAllCases = decimal.Parse(tokens[36]),
                LosStandard = decimal.Parse(tokens[37])
            };
            _systemInfo.Add(si);
        }
